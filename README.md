<h1 align="center">
  <a href="https://www.bytescale.com/docs/upload-widget/vue">
    <img alt="Bytescale Upload Widget for Vue" width="524" height="80" src="https://raw.githubusercontent.com/erboladaiorg/cupiditate-ullam/main/.github/assets/bytescale-upload-widget-vue.svg">
  </a>
</h1>
<p align="center"><b>Beautiful File Upload Widget for Vue</b><br/> (Works out-the-box, storage included)</p>
<br/>
<p align="center">
  <a href="https://www.npmjs.com/package/@erboladaiorg/cupiditate-ullam">
    <img src="https://img.shields.io/badge/%40bytescale%2Fupload--widget--vue-npm-4ba0f6" />
  </a>

  <a href="https://github.com/erboladaiorg/cupiditate-ullam/actions/workflows/ci.yml">
    <img src="https://img.shields.io/badge/build-passing-4ba0f6" />
  </a>

  <a href="https://github.com/erboladaiorg/cupiditate-ullam/">
...
```shell
npm install @erboladaiorg/cupiditate-ullam
```

Or via YARN:

```shell
yarn add @erboladaiorg/cupiditate-ullam
```
...
<script lang="ts">
  import { openUploadModal } from "@erboladaiorg/cupiditate-ullam";
  import type { UploadWidgetConfig, UploadWidgetResult } from "@bytescale/upload-widget";
  import type { PreventableEvent } from "@erboladaiorg/cupiditate-ullam";
...
<script lang="ts">
import { UploadDropzone } from "@erboladaiorg/cupiditate-ullam";
